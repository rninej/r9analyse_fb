    ...
    function e(e) {
      ...
      if (s) {
        var a = o ? require("path").dirname(a) + "/" : __dirname + "/",
          ...
          X = function (e) {
            return (
              re((e = (e = K(e, !0)).buffer ? e : new Uint8Array(e)).buffer), e
            );
          };
      ...
      var At,
        ...
        xt = {
          ...
          L: function (e, t, n, r) {
            ...
            if (!e)
              return d("pthread_create called with a null thread pointer!"), 28;
            var a = [];
          ...
          K: function (e, t) {
            var n = e,
              r = t;
            if (!n)
              return d("pthread_join attempted on a null thread pointer!"), 71;
            if (l && E() == n)
              return (
                d("PThread " + n + " is attempting to join to itself!"), 16
              );
            if (!l && kt() == n)
              return (
                d("Main thread " + n + " is attempting to join to itself!"), 16
              );
            if (_[(n + 12) >> 2] !== n)
              return (
                d(
      ...
      var Qt = !0;
      return (
        i.noInitialRun && (Qt = !1), l && ((ee = !1), g.ib()), Gt(), e.ready
      );
    }
    var Kt;
    (Kt =
