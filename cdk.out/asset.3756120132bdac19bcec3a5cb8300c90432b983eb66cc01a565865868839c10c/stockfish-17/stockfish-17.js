  ...
  function f() {
    function e(e) {
      ...
      if (u) {
        (a = o ? require("path").dirname(a) + "/" : __dirname + "/"),
          ...
          (r = (e, t) => {
            ...
            t instanceof P || m("exiting due to exception: " + t),
              process.exit(e);
          }),
          (c.inspect = function () {
      ...
      function Pe(n, e) {
        n.ta ||
          ...
          (n.getContext = function (e, t) {
            return ("webgl" == e) ==
              (t = n.ta(e, t)) instanceof WebGLRenderingContext
              ? t
              : null;
          }));
        var t,
              ...
              return i(n, (e = new Date(e.$ + 1900, e.ea, e.ia))) < 0
                ? o(
                    Math.ceil(
                      (31 -
                        n.getDate() +
                        ($e(R(e.getFullYear()) ? O : T, e.getMonth() - 1) -
                          31) +
                        e.getDate()) /
                        7
                    ),
      ...
      var ze,
              ...
              : ((a = []),
                d && 0 === a.length
                  ...
                  : ((e = { Ka: n, qa: e, fa: r, Pa: a }),
                    d
                      ? ((e.Qa = "spawnThread"), postMessage(e, a), 0)
                      : xe(e)));
          },
          g: ke,
          v: Ee,
        ...
        et =
          ((c.__emscripten_thread_crashed = function () {
            return (c.__emscripten_thread_crashed = c.asm.K).apply(
              null,
              arguments
            );
          }),
          ...
          (c.__emscripten_thread_init = function () {
            return (et = c.__emscripten_thread_init = c.asm.M).apply(
              null,
              arguments
            );
          })),
        ...
        at = (c._emscripten_dispatch_to_thread_ = function () {
          return (at = c._emscripten_dispatch_to_thread_ = c.asm.R).apply(
            null,
            arguments
          );
        }),
        ot = (c.__emscripten_thread_free_data = function () {
          return (ot = c.__emscripten_thread_free_data = c.asm.S).apply(
            null,
            arguments
          );
        }),
        it =
          ((c.__emscripten_thread_exit = function () {
            return (c.__emscripten_thread_exit = c.asm.T).apply(
              null,
              arguments
            );
          }),
        ...
        ut = (c._emscripten_stack_set_limits = function () {
          return (ut = c._emscripten_stack_set_limits = c.asm.X).apply(
            null,
            arguments
          );
        }),
      ...
      function pt(e) {
        ...
        b() || d || E.ra(),
          b() || (E.ra(), c.onExit && c.onExit(e), (J = !0)),
          r(e, new P(e));
      }
      if (
      ...
      !(function (e, t) {
        ...
        (function (t) {
          return function (e) {
            ++r,
              (a[t] = e),
              r === n && ((e = URL.createObjectURL(new Blob(a))), u(e));
          };
        })(e)
      );
  }
