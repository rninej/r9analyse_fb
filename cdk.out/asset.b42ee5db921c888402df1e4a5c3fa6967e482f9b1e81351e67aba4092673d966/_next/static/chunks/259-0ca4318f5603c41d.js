...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  ...
  {
    658: (p, n, P) => {
      P.d(n, { Yn: () => e, ZH: () => a, yy: () => i });
      let e = (p) => (p < 10 ? "0".concat(p) : p),
        a = (p) => p.charAt(0).toUpperCase() + p.slice(1),
        i = (p) => new Promise((n) => setTimeout(n, p));
    },
    3242: (p, n, P) => {
      P.d(n, { e1: () => s, Cv: () => R, vc: () => o });
      var e = P(4393),
        a = (function (p) {
          return (
            (p.NotFound = "No cloud evaluation available for that position"), p
          );
        })({}),
        i = P(80703),
        r = P(65364);
      let t = () => !!r.env.NEXT_PUBLIC_SENTRY_DSN && i.Dp(),
        b = (p, n) => {
          t() ? i.Cp(p, { extra: n }) : console.error(p);
        };
      var B = P(24307);
      let R = async function (p) {
          let n =
          ...
          try {
            ...
            let i = P.pvs.map((n, e) => ({
              pv: (0, B.T)(p, n.moves.split(" ")),
              cp: n.cp,
              mate: n.mate,
              depth: P.depth,
              multiPv: e + 1,
            }));
            i.sort(e.e2), "w" !== p.split(" ")[1] && i.reverse();
            let r = i[0].pv[0],
              t = i.slice(0, n);
            return { bestMove: r, lines: t };
          } catch (P) {
            return b(P, { fen: p, multiPv: n }), { bestMove: "", lines: [] };
          }
        },
        o = async (p, n) => {
          let P = await fetch(
        ...
        N = async (p, n) => {
          try {
            ...
            return console.error(p), { error: a.NotFound };
          }
        },
        s = async (p, n) => {
          try {
            ...
            if (P.status >= 400)
              throw Error("Error fetching game ".concat(p, " from Lichess"));
        ...
        m = (p) => {
          ...
          return {
            ...
            white: {
              name:
                (null === (n = p.players.white.user) || void 0 === n
                  ? void 0
                  : n.name) || "White",
              rating: p.players.white.rating,
              title:
                null === (P = p.players.white.user) || void 0 === P
                  ? void 0
                  : P.title,
            },
            black: {
              name:
                (null === (e = p.players.black.user) || void 0 === e
                  ? void 0
                  : e.name) || "Black",
              rating: p.players.black.rating,
              title:
                null === (a = p.players.black.user) || void 0 === a
                  ? void 0
                  : a.title,
            },
            result: f(p),
            timeControl: ""
              ...
              .concat(
                (null === (r = p.clock) || void 0 === r
                  ? void 0
                  : r.increment) || 0
              ),
            date: new Date(p.createdAt || p.lastMoveAt).toLocaleDateString(),
            movesNb:
              (null === (t = p.moves) || void 0 === t
                ? void 0
                : t.split(" ").length) || 0,
            url: "https://lichess.org/".concat(p.id),
          };
        },
        f = (p) =>
          "draw" === p.status
    ...
    3816: (p, n, P) => {
      ...
      let a = async (p, n) => {
          ...
          if (
            R.status >= 400 &&
            "Date cannot be set in the future" !== o.message
          )
            throw Error("Error fetching games from Chess.com");
          let N =
            null !== (P = null == o ? void 0 : o.games) && void 0 !== P
              ? P
              : [];
          if (N.length < 50) {
            let n = 1 === b ? 12 : b - 1,
              ...
              r = await i.json();
            N.push(
              ...(null !== (a = null == r ? void 0 : r.games) && void 0 !== a
                ? a
                : [])
            );
          }
          return N.filter((p) => p.pgn && p.end_time)
            .sort((p, n) => n.end_time - p.end_time)
            .slice(0, 50)
            .map(r);
        },
        i = async (p) => {
          let n = encodeURIComponent(p.trim().toLowerCase()),
            P = await fetch("https://api.chess.com/pub/player/".concat(n)),
            e = await P.json(),
            a = null == e ? void 0 : e.avatar;
          return "string" == typeof a ? a : null;
        },
        r = (p) => {
          var n, P, e, a, i, r, b, B, R;
          let o =
              null === (n = p.pgn.match(/\[Result "(.*?)"]/)) || void 0 === n
                ? void 0
                : n[1],
            N =
              null === (P = p.pgn.match(/\d+?\. /g)) || void 0 === P
                ? void 0
                : P.length;
          return {
            id:
              p.uuid ||
              (null === (e = p.url) || void 0 === e
                ? void 0
                : e.split("/").pop()) ||
              p.id,
            pgn: p.pgn || "",
            white: {
              name:
                (null === (a = p.white) || void 0 === a
                  ? void 0
                  : a.username) || "White",
              rating:
                (null === (i = p.white) || void 0 === i ? void 0 : i.rating) ||
                0,
              title: null === (r = p.white) || void 0 === r ? void 0 : r.title,
            },
            black: {
              name:
                (null === (b = p.black) || void 0 === b
                  ? void 0
                  : b.username) || "Black",
              rating:
                (null === (B = p.black) || void 0 === B ? void 0 : B.rating) ||
                0,
              title: null === (R = p.black) || void 0 === R ? void 0 : R.title,
            },
            result: o,
            timeControl: t(p),
            date: p.end_time
              ? new Date(1e3 * p.end_time).toLocaleDateString()
              : new Date().toLocaleDateString(),
            movesNb: N ? 2 * N : void 0,
            url: p.url,
          };
        },
        t = (p) => {
          let n = p.time_control;
          if (!n) return;
          let [P, a] = n.split("+");
          if (!P) return;
          let i = Number(P),
            r = a ? "+".concat(a) : "";
          if (i < 60) return "".concat(i, "s").concat(r);
          if (i < 3600) {
            let p = Math.floor(i / 60),
              n = i % 60;
            return n
              ? ""
                  .concat(p, "m")
          ...
          let t = Math.floor(i / 3600),
            b = Math.floor((i % 3600) / 60);
          return b
            ? ""
                .concat(t, "h")
                .concat((0, e.Yn)(b), "m")
    ...
    4393: (p, n, P) => {
      ...
      let a = (p, n) => {
          ...
          for (let a of p) {
            ...
            if (a.startsWith("info")) {
              let p = t(a, n),
                P = r(a, "multipv"),
                i = r(a, "depth");
              if (!p || !P || !i || (e[P] && parseInt(i) < e[P].depth))
                continue;
              let b = r(a, "cp"),
                B = r(a, "mate");
              e[P] = {
                pv: p,
                cp: b ? parseInt(b) : void 0,
                mate: B ? parseInt(B) : void 0,
                depth: parseInt(i),
                multiPv: parseInt(P),
              };
            }
          ...
          return (
            (P.lines = Object.values(e).sort(i)),
            "w" !== n.split(" ")[1] &&
              (P.lines = P.lines.map((p) => ({
                ...p,
                cp: p.cp ? -p.cp : p.cp,
                mate: p.mate ? -p.mate : p.mate,
              }))),
            P
          );
        },
        i = (p, n) => {
          var P, e;
          return void 0 !== p.mate && void 0 !== n.mate
            ? p.mate - n.mate
            : void 0 !== p.mate
              ? -p.mate
              : void 0 !== n.mate
                ...
                : (null !== (P = n.cp) && void 0 !== P ? P : 0) -
                  (null !== (e = p.cp) && void 0 !== e ? e : 0);
        },
        r = (p, n) => {
          let P = p.split(" "),
            e = P.indexOf(n);
          if (-1 !== e && !(e + 1 >= P.length)) return P[e + 1];
        },
        t = (p, n) => {
          let P = p.split(" "),
            a = P.indexOf("pv");
    ...
    14679: (p, n, P) => {
      ...
      class t {
        static async create(p) {
          if (!t.isSupported()) throw Error("Stockfish 16 is not supported");
          let n = (0, i.eO)();
          n || console.log("Single thread mode");
          let P = async (n) => {
              await (0, r.Wj)(
                n,
                ["setoption name Use NNUE value ".concat(!!p), "isready"],
                "readyok"
              );
            },
            b = p ? e.Qz.Stockfish16NNUE : e.Qz.Stockfish16;
          return a.Y.create(
            b,
            n
    ...
    24026: (p, n, P) => {
      ...
      class i {
        static async create() {
          return a.Y.create(e.Qz.Stockfish11, "engines/stockfish-11.js");
        }
        static isSupported() {
          return !0;
        }
    ...
    24307: (p, n, P) => {
      ...
      var e = P(22277),
        ...
        i = P(19271);
      let r = (p) => {
          let n = p.history({ verbose: !0 }),
            P = n.map((p) => p.before);
          return (
            P.push(n[n.length - 1].after),
            {
              fens: P,
              uciMoves: n.map((p) => p.from + p.to + (p.promotion || "")),
            }
          );
        },
        t = (p) => {
          let n = new e.d$();
          return n.loadPgn(p), n;
        },
        b = (p) => {
          var n;
          let P = p.getHeaders();
        ...
        B = (p, n) => (p.history().length ? p : R(n)),
        R = function (p) {
          let n =
            arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
          p.setHeader("Event", "Chesskit Game"),
            p.setHeader("Site", "Chesskit.org"),
            p.setHeader(
              "Date",
              new Date().toISOString().split("T")[0].replace(/-/g, ".")
            );
          let { white: P, black: e, resigned: a } = n,
            i = p.getHeaders().White,
            r = p.getHeaders().Black,
            t = (null == P ? void 0 : P.name) || ("?" !== i ? i : "White"),
            b = (null == e ? void 0 : e.name) || ("?" !== r ? r : "Black");
          return (
            p.setHeader("White", t),
            p.setHeader("Black", b),
            (null == P ? void 0 : P.rating) &&
              p.setHeader("WhiteElo", "".concat(P.rating)),
            (null == e ? void 0 : e.rating) &&
              p.setHeader("BlackElo", "".concat(e.rating)),
            a &&
              (p.setHeader("Result", "w" === a ? "0-1" : "1-0"),
              p.setHeader(
                "Termination",
                "".concat("w" === a ? b : t, " won by resignation")
              )),
            p.isGameOver() &&
              (p.isCheckmate() &&
                (p.setHeader("Result", "w" === p.turn() ? "0-1" : "1-0"),
                p.setHeader(
                  "Termination",
                  "".concat("w" === p.turn() ? b : t, " won by checkmate")
                )),
              p.isInsufficientMaterial() &&
                (p.setHeader("Result", "1/2-1/2"),
                p.setHeader("Termination", "Draw by insufficient material")),
              p.isStalemate() &&
                (p.setHeader("Result", "1/2-1/2"),
                p.setHeader("Termination", "Draw by stalemate")),
              p.isThreefoldRepetition() &&
                (p.setHeader("Result", "1/2-1/2"),
                p.setHeader("Termination", "Draw by threefold repetition"))),
            p
          );
        },
        o = (p) => {
        ...
        N = (p) => {
          ...
          let e = P.cp;
          if (!e) return { whiteBarPercentage: n, label: "0.0" };
          let i = Math.abs(e) / 100,
            r = i.toFixed(1);
          return (
            r.toString().length > 3 && (r = i.toFixed(0)),
            { whiteBarPercentage: n, label: r }
          );
        },
        s = (p) => new e.d$(p).isStalemate(),
        m = (p) => {
          let n = new e.d$(p);
        ...
        K = (p, n, P) => {
          ...
          let a = new e.d$(p),
            ...
            r = l(p),
            t = [n, ...P];
          t.length % 2 == 1 && (t = t.slice(0, -1));
          let b = 1,
            B = { w: [], b: [] };
          for (let p of t)
            try {
              let n = a.move(f(p));
              if (n.captured) B[n.color].push(n.captured), (b = 1);
              else if (--b < 0) break;
            } catch (p) {
              return console.error(p), !1;
            }
          for (let p of B.w.slice(0))
            B.b.includes(p) &&
              (B.b.splice(B.b.indexOf(p), 1), B.w.splice(B.w.indexOf(p), 1));
          if (
            1 >= Math.abs(B.w.length - B.b.length) &&
            B.w.concat(B.b).every((p) => "p" === p)
          )
            return !1;
          let R = l(a.fen()) - r;
          return (i ? R : -R) < 0;
        ...
        Q = (p, n) => {
          ...
          return P.map((p) => {
            var n, P;
            let { piece: a, count: i } = p,
              r =
                null === (n = e.match(RegExp(a, "g"))) || void 0 === n
                  ? void 0
                  : n.length;
            return {
              piece: null !== (P = q[a]) && void 0 !== P ? P : a,
              count: Math.max(0, i - (null != r ? r : 0)),
            };
          });
        },
        q = {
        ...
        D = (p) =>
          void 0 !== p.cp
            ? "".concat(p.cp > 0 ? "+" : "").concat((p.cp / 100).toFixed(2))
            : p.mate
              ? "".concat(p.mate > 0 ? "+" : "-", "M").concat(Math.abs(p.mate))
              : "?",
        h = (p, n) => {
          let P = p.split(" ")[2],
            e = P.includes("K"),
    ...
    26611: (p, n, P) => {
      P.d(n, { Go: () => e, d4: () => a, f8: () => r, lW: () => i });
      let e = (p, n, P) => (p > P ? P : p < n ? n : p),
        a = (p) => {
          let n = p.reduce((p, n) => p + 1 / n, 0);
          return p.length / n;
        },
        i = (p) => {
          let n = p.length,
            P = p.reduce((p, n) => p + n) / n;
          return Math.sqrt(
            p.map((p) => Math.pow(p - P, 2)).reduce((p, n) => p + n) / n
          );
        },
        r = (p, n) => {
          if (p.length > n.length) throw Error("Weights array is too short");
          return (
            p.reduce((p, P, e) => p + P * n[e], 0) /
            n.slice(0, p.length).reduce((p, n) => p + n, 0)
          );
        };
    },
    27064: (p, n, P) => {
      ...
      let B = (0, i.eU)([]),
        R = (0, i.eU)(!1),
        o = (p) => {
          let [n, P] = (0, b.useState)(null),
            [i, o] = (0, r.fp)(B),
            [N, s] = (0, r.fp)(R),
            [m, f] = (0, b.useState)(void 0);
          (0, b.useEffect)(() => {
            void 0 !== p && s(p);
          }, [p, s]),
            (0, b.useEffect)(() => {
              (async () => {
                P(
                  await (0, a.P2)("games", 1, {
                    upgrade(p) {
                      p.createObjectStore("games", {
                        keyPath: "id",
                        autoIncrement: !0,
                      });
                    },
          ...
          let k = (0, b.useCallback)(async () => {
            n && N && o(await n.getAll("games"));
          }, [n, N, o]);
          (0, b.useEffect)(() => {
            k();
          }, [k]);
          let K = (0, b.useCallback)(
              async (p) => {
                if (!n) throw Error("Database not initialized");
                let P = (0, e.mi)(p),
                  a = await n.add("games", P);
                return k(), a;
              },
              [n, k]
            ),
            l = (0, b.useCallback)(
              async (p, P) => {
                if (!n) throw Error("Database not initialized");
                let e = await n.get("games", p);
                if (!e) throw Error("Game not found");
                await n.put("games", { ...e, eval: P }), k();
              },
              [n, k]
            ),
            c = (0, b.useCallback)(
              async (p) => {
                if (n) return n.get("games", p);
              },
              [n]
            ),
            Q = (0, b.useCallback)(
              async (p) => {
                if (!n) throw Error("Database not initialized");
                await n.delete("games", p), k();
              },
              [n, k]
            ),
            { gameId: q } = (0, t.useRouter)().query;
          return (
            (0, b.useEffect)(() => {
              "string" == typeof q
                ? c(parseInt(q)).then((p) => {
    ...
    29791: (p, n, P) => {
      ...
      let t = (p, n, P) => {
          ...
          return p.map((R, N) => {
            ...
            if (0 === N) return R;
            let m = P[N].split(" ")[0],
              f = i.m.find((p) => p.fen === m);
            if (f)
              return (
                (r = f.name),
                { ...R, opening: f.name, moveClassification: a.eK.Opening }
              );
            let k = p[N - 1];
            if (1 === k.lines.length)
              return { ...R, opening: r, moveClassification: a.eK.Forced };
            let K = n[N - 1],
              l =
                null === (s = k.lines.filter((p) => p.pv[0] !== K)) ||
                void 0 === s
                  ? void 0
                  : s[0],
              c = l ? (0, e.h)(l) : void 0,
              ...
              D = t[N],
              h = N % 2 == 1;
            if (B(q, D, h, K, Q, P[N - 1], c))
              return { ...R, opening: r, moveClassification: a.eK.Splendid };
            if (
              o(
                q,
                D,
                ...
                c,
                N > 1 ? P[N - 2] : null,
                N > 1 ? [n[N - 2], n[N - 1]] : null
              )
            )
              return { ...R, opening: r, moveClassification: a.eK.Perfect };
            if (K === k.bestMove)
              return { ...R, opening: r, moveClassification: a.eK.Best };
            let d = b(q, D, h);
            return { ...R, opening: r, moveClassification: d };
          });
        },
        b = (p, n, P) => {
          let e = (n - p) * (P ? 1 : -1);
        ...
        R = (p, n, P) => (P ? p < 50 : p > 50) || (P ? n > 97 : n < 3),
        o = (p, n, P, e, a, i) => {
          if (
            !e ||
            (n - p) * (P ? 1 : -1) < -2 ||
    ...
    39228: (p, n, P) => {
      ...
      class r {
        static async create(p) {
          if (!r.isSupported()) throw Error("Stockfish 17 is not supported");
          let n = (0, i.eO)();
          n || console.log("Single thread mode");
          let P = "engines/stockfish-17/stockfish-17"
              .concat(p ? "-lite" : "")
              .concat(n ? "" : "-single", ".js"),
            t = p ? e.Qz.Stockfish17Lite : e.Qz.Stockfish17;
          return a.Y.create(t, P);
        }
        static isSupported() {
          return (0, i.TH)();
        }
    ...
    43699: (p, n, P) => {
      ...
      class r {
        static async create(p) {
          if (!r.isSupported()) throw Error("Stockfish 16.1 is not supported");
          let n = (0, i.eO)();
          n || console.log("Single thread mode");
          let P = "engines/stockfish-16.1/stockfish-16.1"
              .concat(p ? "-lite" : "")
              .concat(n ? "" : "-single", ".js"),
            t = p ? e.Qz.Stockfish16_1Lite : e.Qz.Stockfish16_1;
          return a.Y.create(t, P);
        }
        static isSupported() {
          return (0, i.TH)();
    ...
    47713: (p, n, P) => {
      ...
      let b = () =>
        ...
        B = () => {
          try {
            return void 0 !== SharedArrayBuffer && !R();
          } catch (p) {
            return !1;
          }
        },
        R = () => /iPhone|iPad|iPod/i.test(navigator.userAgent),
        o = () => R() || /Android|Opera Mini/i.test(navigator.userAgent),
        N = (p) => {
          switch (p) {
            case e.Qz.Stockfish17:
            case e.Qz.Stockfish17Lite:
              return t.f.isSupported();
            case e.Qz.Stockfish16_1:
            case e.Qz.Stockfish16_1Lite:
              return r.m.isSupported();
            case e.Qz.Stockfish16:
            case e.Qz.Stockfish16NNUE:
              return i.K.isSupported();
            case e.Qz.Stockfish11:
    ...
    67405: (p, n, P) => {
      ...
      let r = (p) => {
          let n = p.map(i.g),
            P = b(n),
            e = B(n);
          return { white: t(e, P, "white"), black: t(e, P, "black") };
        },
        t = (p, n, P) => {
          let e = +("white" !== P),
            i = p.filter((p, n) => n % 2 === e),
            r = n.filter((p, n) => n % 2 === e);
          return ((0, a.f8)(i, r) + (0, a.d4)(i)) / 2;
        },
        b = (p) => {
          let n = (0, a.Go)(Math.ceil(p.length / 10), 2, 8),
            P = [],
            e = Math.round(n / 2);
            ...
            return Math.min(
              ...
              Math.max(
                ...
                103.1668100711649 *
                  Math.exp(
                    -0.04354415386753951 *
                      (P % 2 == 0 ? Math.max(0, e - n) : Math.max(0, n - e))
                  ) -
                  3.166924740191411 +
                  1
              )
      ...
      let s = (p, n, P) => {
          ...
          let { whiteCpl: e, blackCpl: a } = f(p);
          return {
            white: l(e, null != n ? n : P),
            black: l(a, null != P ? P : n),
          };
        },
        m = (p) => {
          let n = p.lines[0];
        ...
        f = (p) => {
          let n = m(p[0]),
            { whiteCpl: P, blackCpl: e } = p.slice(1).reduce(
              (p, P, e) => {
                let a = m(P);
                return (
                  e % 2 == 0
                    ? (p.whiteCpl += a > n ? 0 : Math.min(n - a, 1e3))
                    : (p.blackCpl += a < n ? 0 : Math.min(a - n, 1e3)),
                  (n = a),
                  p
                );
              },
          ...
          return {
            whiteCpl: P / Math.ceil((p.length - 1) / 2),
            blackCpl: e / Math.floor((p.length - 1) / 2),
          };
        },
        k = (p) => 3100 * Math.exp(-0.01 * p),
        K = (p) => -100 * Math.log(Math.min(p, 3100) / 3100),
        l = (p, n) => {
          let P = k(p);
          if (!n) return P;
          let e = p - K(n);
      ...
      var c = P(92634);
      class Q {
        static async create(p, n, P) {
          let e = new Q(p, n, P);
          return await e.addNewWorker(), (e.isReady = !0), e;
        }
        acquireWorker() {
          for (let p of this.workers) if (p.isReady) return (p.isReady = !1), p;
        }
        async releaseWorker(p) {
          ...
          this.releaseWorker(p), n.resolve(P);
        }
        async setMultiPv(p) {
          if (p !== this.multiPv) {
            if (p < 2 || p > 6)
              throw Error("Invalid MultiPV value : ".concat(p));
            await this.sendCommandsToEachWorker(
              ["setoption name MultiPV value ".concat(p), "isready"],
              "readyok"
            ),
              (this.multiPv = p);
          }
        ...
        async setElo(p) {
          if (p !== this.elo) {
            if (p < 1320 || p > 3190)
              throw Error("Invalid Elo value : ".concat(p));
            await this.sendCommandsToEachWorker(
              ["setoption name UCI_LimitStrength value true", "isready"],
              "readyok"
            ),
              await this.sendCommandsToEachWorker(
                ["setoption name UCI_Elo value ".concat(p), "isready"],
                "readyok"
              ),
              (this.elo = p);
          }
        ...
        async stopAllCurrentJobs() {
          for (let p of ((this.workerQueue = []),
          await this.sendCommandsToEachWorker(["stop", "isready"], "readyok"),
          this.workers))
            this.releaseWorker(p);
        }
        async sendCommands(p, n, P) {
          let e = this.acquireWorker();
          if (!e)
          ...
          let a = await (0, c.Wj)(e, p, n, P);
          return this.releaseWorker(e), a;
        }
        async sendCommandsToEachWorker(p, n, P) {
          await Promise.all(
            this.workers.map(async (e) => {
              await (0, c.Wj)(e, p, n, P), this.releaseWorker(e);
            })
          );
        }
        async addNewWorker() {
          var p;
          let n = (0, c.JX)(this.enginePath);
          await (0, c.Wj)(n, ["uci"], "uciok"),
            await (0, c.Wj)(
              n,
              ["setoption name MultiPV value ".concat(this.multiPv), "isready"],
              "readyok"
            ),
            await (null === (p = this.customEngineInit) || void 0 === p
              ? void 0
              : p.call(this, n)),
            await (0, c.Wj)(n, ["ucinewgame", "isready"], "readyok"),
            this.workers.push(n),
            this.releaseWorker(n);
        }
        async setWorkersNb(p) {
          if (p === this.workers.length) return;
          if (p < 1)
            throw Error(
          ...
          if (p < this.workers.length) {
            let n = this.workers.slice(p);
            for (let P of ((this.workers = this.workers.slice(0, p)), n))
              this.terminateWorker(P);
            return;
          }
          let n = p - this.workers.length;
          await Promise.all(
            Array(n)
              .fill(0)
        ...
        async evaluateGame(p) {
          ...
          this.throwErrorIfNotReady(),
            ...
            this.setWorkersNb(b);
          let B = Array(n.length),
            o = 0,
            m = (p, P) => {
              o++, (B[p] = P);
              let e = o / n.length;
              null == i || i(99 - 99 * Math.exp(-4 * e));
            };
          await Promise.all(
            n.map(async (p, n) => {
              let P = (0, R.sI)(p);
              ...
              m(n, await this.evaluatePosition(p, e, b));
            })
          ),
          ...
          return {
            ...
            estimatedElo: s(
              B,
              null == t ? void 0 : t.white,
              null == t ? void 0 : t.black
            ),
            accuracy: k,
            settings: {
              engine: this.name,
        ...
        async evaluatePosition(p) {
          ...
          if (P < 2) {
            let P = await (0, o.Cv)(p, this.multiPv);
            if (P.lines.length >= this.multiPv && P.lines[0].depth >= n)
              return P;
          }
          let a = await this.sendCommands(
            ["position fen ".concat(p), "go depth ".concat(n)],
            "bestmove"
          );
          return (0, e.ue)(a, p);
        }
        async evaluatePositionWithUpdate(p) {
          let {
            fen: n,
            depth: P = 16,
            multiPv: a = this.multiPv,
          ...
          let t = await r;
          if (t.lines.length >= a && t.lines[0].depth >= P)
            return null == i || i(t), t;
          let b = await this.sendCommands(
        ...
        async getEngineNextMove(p, n) {
          let P =
            arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 16;
          this.throwErrorIfNotReady(),
            await this.stopAllCurrentJobs(),
            await this.setElo(n),
            console.log("Evaluating position: ".concat(p));
          let a = (
              await this.sendCommands(
                ["position fen ".concat(p), "go depth ".concat(P)],
                "bestmove"
              )
            ).find((p) => p.startsWith("bestmove")),
            i = (0, e.VJ)(null != a ? a : "", "bestmove");
          if (!i) throw Error("No move found");
          return "(none)" === i ? void 0 : i;
        }
        constructor(p, n, P) {
          (this.workers = []),
            (this.workerQueue = []),
    ...
    73004: (p, n, P) => {
      ...
      let a = (p) => i(p.lines[0]),
        i = (p) => {
          if (void 0 !== p.cp) return t(p.cp);
          if (void 0 !== p.mate) return r(p.mate);
          throw Error("No cp or mate in line");
        },
        r = (p) => t((1 / 0) * p),
        t = (p) =>
          50 +
          50 * (2 / (1 + Math.exp(-0.00368208 * (0, e.Go)(p, -1e3, 1e3))) - 1);
    },
    92634: (p, n, P) => {
      P.d(n, { JX: () => a, PN: () => r, Wj: () => i });
      var e = P(47713);
      let a = (p) => {
          console.log("Creating worker from ".concat(p));
          let n = new window.Worker(p),
            P = {
              isReady: !1,
              uci: (p) => n.postMessage(p),
              listen: () => null,
        ...
        i = (p, n, P, e) =>
          new Promise((a) => {
            let i = [];
            for (let r of ((p.listen = (p) => {
              i.push(p), null == e || e(i), p.startsWith(P) && a(i);
            }),
            n))
              p.uci(r);
          }),
      ...
      let r = (p) => {
        ...
        return (0, e.jsxs)(i(), {
          children: [
            ...
            (0, e.jsx)("meta", { property: "og:title", content: n }),
          ],
        });
      };
    },
